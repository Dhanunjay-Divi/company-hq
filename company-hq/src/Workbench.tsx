...
export default function Workbench() {
  ...
  return <div className="desktop-frame">
    <header className="window-chrome" aria-label="Company HQ application shell">
      ...
      <div className="window-command"><Command size={14}/><span>Company HQ · agent IDE shell</span><kbd>⌘K</kbd></div>
    ...
    <aside className={`sidebar ${mobileNav ? 'is-open' : ''}`}>
      ...
      <div className="ide-mode-card"><span><Monitor size={14}/> Local app shell</span><span><GitBranch size={14}/> Worktree-ready control plane</span></div>
      ...
      {!team && <button className="sidebar-start" onClick={() => setDialog('workspace')}>Connect your first project</button>}
