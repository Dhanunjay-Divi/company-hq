...
export default function OperatingGuide({ demo, health, runtime }: Props) {
  ...
  return <div className="operating-guide">
    ...
    <section className="guide-grid">
      ...
      <article><Gauge size={22}/><h3>Usage discipline</h3><p>The run screen shows provider-reported token counts when the native runtime emits them. Account-wide quota, credits and billed money are separate. Use smaller models first, reuse code intelligence before broad reads, compress noisy command output only when evidence is preserved, and stop when a budget gate is hit.</p></article>
