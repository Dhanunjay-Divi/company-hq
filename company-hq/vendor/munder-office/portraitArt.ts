// Adapted from chaitanyagiri/munder-difflin c7c8921f4491104d342861e32fa214e486442304.
// Copyright (c) 2026 Chaitanya Giri. MIT; see adjacent LICENSE.
// HQ change: inline the type-only cast dependency; no external art or Pixi runtime.
...
export type OfficeCharacterName = 'michael' | 'jim' | 'pam' | 'dwight' | 'kevin' | 'angela' | 'oscar' | 'stanley' | 'phyllis' | 'andy' | 'kelly' | 'ryan' | 'toby' | 'creed' | 'meredith';
